...
def clear_session():
    try:
        ...
        # Reset model states and training history
        if hasattr(app, 'model_state'):
            app.model_state = None
        
        # Clear any global variables storing model or training data
        global_vars = ['model', 'optimizer', 'train_losses', 'predictions', 'actuals']
        ...
        # Redirect stdout to clear console output
        ...
        return jsonify({
            'success': True,
            'message': 'All data, models, and training history cleared successfully'
        })
